        ...
        <div className="container">
          <div className="st-main-header-in">
            <div className="st-main-header-left">
              <Link className="st-site-branding" to='/' id="hero"><img src="https://res.cloudinary.com/dgtsyf1vu/image/upload/v1726313720/Atman-logo_fpia1r.png" alt="Atman Law" /></Link>
            </div>
            <div className="st-main-header-right">
              <div className="st-nav">
                <ul className="st-nav-list st-onepage-nav" style={{ display: `${mobileToggle ? 'block' : 'none'}` }}>
                  ...
                  <li><ScrollLink to="about" spy={true} smooth={true} offset={-80} duration={500} onClick={() => setMobileToggle(false)}>About Us</ScrollLink></li>
                  <li><ScrollLink to="portfolio" spy={true} smooth={true} offset={-80} duration={500} onClick={() => setMobileToggle(false)}>Our Services</ScrollLink></li>
                ...
                <div className="sp-phone">
                  ...
                  <div className="sp-phone-no">+1(91)-7022937009</div>
                </div>
              </div>
            </div>
          </div>
